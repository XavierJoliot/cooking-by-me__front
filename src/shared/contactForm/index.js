...
const ContactForm = () => (
  <section className='contact'>
    ...
    <form className='contact__form'>
      ...
      <Input name='email' type='email' label='Mail :' placeholder="Renseignez votre mail." value='' isRequired={true} />
      <Input name='object' type='text' label='Objet :' placeholder="Entrez l'objet de votre demande." value='' isRequired={true} />
      <Input name='content' type='textarea' label='Message :' placeholder="Entrez votre message" value='' isRequired={true} />
